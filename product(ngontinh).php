...
<body>
    ...
    <div class="new__product">
        <h2 class="new__product-title" style="font-size: 50px;">Những tác phẩm thuộc thể loại Ngôn Tình</h2>
                
    <?php
    $sql = "select * from product where idcategory = 0126 ";
...
<?php
    ...
    <center>
        ...
        <a href="product(ngontinh).php?cat=<?php echo $a; ?>&page=1">1</a>
